...
const DB=localDB(),env={DB,AUTH_PROVIDER:'sites',APP_ORIGIN:'https://game.example',STRIPE_SECRET_KEY:'sk_test_example',STRIPE_WEBHOOK_SECRET:'whsec_example',AUCTION_OWNER_EMAIL:'owner@example.com'};
